...
const SEO: Record<string, { title: string; description: string; jsonLd?: object | object[] }> = {
  ...
  "/blog/save-whatsapp-screenshots-organized": {
    ...
    ogImage: "/blog/blog-whatsapp.png",
    jsonLd: faqSchema([
  ...
  "/blog/organize-screenshots-automatically": {
    ...
    ogImage: "/blog/blog-organize.png",
    jsonLd: faqSchema([
  ...
  "/blog/how-to-delete-duplicate-screenshots": {
    ...
    ogImage: "/blog/blog-duplicates.png",
    jsonLd: faqSchema([
  ...
  "/blog/organize-payment-receipt-screenshots": {
    ...
    ogImage: "/blog/blog-payments.png",
    jsonLd: faqSchema([
...
function SeoManager() {
  ...
  useSeo({ title: seo.title, description: seo.description, path: location, ogImage: seo.ogImage, jsonLd: seo.jsonLd });
  return null;
}
